...
public class ScoreCubeHighThenLeaveLowProgram extends SequentialCommandGroup {

    public ScoreCubeHighThenLeaveLowProgram(ScoreCubeHighCommandGroup scoreCubeHighCommandGroup,
        ...
        moveOutOfCommunity.setTargetSupplier(
                () -> {
                    var wpiXY = AutoLandmarks.convertBlueToRedIfNeeded(
                            AutoLandmarks.blueLowerCheckpointOutsideCommunity
                    ).getTranslation();
